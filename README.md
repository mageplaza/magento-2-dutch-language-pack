...
![Dutch language pack process](https://progress-bar.dev//?title=completed)
...
```
composer require mageplaza/magento-2-dutch-language-pack:dev-master avada/module-proofo
